...
public class EnhancementController {
    ...
    @PostMapping
    public Enhancement create(@RequestBody Enhancement enhancement) {
        if (enhancement.getId() == null || enhancement.getId().isBlank()) {
            enhancement.setId(slugify(enhancement.getTitle()));
        }
        return service.save(enhancement);
    }

    private String slugify(String value) {
        if (value == null || value.isBlank()) {
            return "enhancement-" + System.currentTimeMillis();
        }
